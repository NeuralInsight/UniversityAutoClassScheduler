...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        Dialog.resize(1024, 758)
        Dialog.setMinimumSize(QtCore.QSize(1024, 758))
        Dialog.setMaximumSize(QtCore.QSize(1024, 758))
        ...
        self.btnViewCompleteRes = QtWidgets.QPushButton(self.groupBox_6)
        self.btnViewCompleteRes.setObjectName("btnViewCompleteRes")
    ...
    def retranslateUi(self, Dialog):
        ...
        self.btnViewCompleteRes.setText(_translate("Dialog", "View Complete Result"))
