...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.groupBox_10 = QtWidgets.QGroupBox(self.tabInstructors)
        ...
        self.groupBox_10.setMinimumSize(QtCore.QSize(10, 70))
        self.groupBox_10.setObjectName("groupBox_10")
        self.txtEditInsSearch = QtWidgets.QLineEdit(self.groupBox_10)
        self.txtEditInsSearch.setGeometry(QtCore.QRect(0, 30, 411, 25))
        self.txtEditInsSearch.setObjectName("txtEditInsSearch")
        self.lblInsSearch = QtWidgets.QLabel(self.groupBox_10)
        self.lblInsSearch.setGeometry(QtCore.QRect(580, 40, 67, 17))
        self.lblInsSearch.setText("")
        self.lblInsSearch.setObjectName("lblInsSearch")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.btnInstrImport.setText(_translate("MainWindow", "Import from Excel"))
        self.groupBox_10.setTitle(_translate("MainWindow", "Search"))
        ...
        self.btnRoomImport.setText(_translate("MainWindow", "Import from Excel"))
        ...
        self.btnSubjImport.setText(_translate("MainWindow", "Import from Excel"))
        ...
        self.btnScenResult.setText(_translate("MainWindow", "Export Results"))
        self.groupBox_6.setTitle(_translate("MainWindow", "Operation Settings"))
