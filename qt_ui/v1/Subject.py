...
class Ui_Dialog(object):
    ...
    def retranslateUi(self, Dialog):
        ...
        Dialog.setWindowTitle(_translate("Dialog", "درس"))
        self.lblHours.setText(_translate("Dialog", "ساعت در هفته"))
        self.lblName.setText(_translate("Dialog", "نام"))
        self.groupBox_2.setTitle(_translate("Dialog", "زمانبندی قابل تقسیم"))
        self.radioYes.setText(_translate("Dialog", "بله"))
        self.radioNo.setText(_translate("Dialog", "خیر"))
        self.groupBox.setTitle(_translate("Dialog", "نوع"))
        self.radioAny.setText(_translate("Dialog", "نظری و عملی"))
