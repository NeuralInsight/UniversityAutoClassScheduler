...
class Ui_Dialog(object):
    ...
    def retranslateUi(self, Dialog):
        ...
        Dialog.setWindowTitle(_translate("Dialog", "رشته"))
        self.lblName.setText(_translate("Dialog", "نام"))
        self.lblOJT.setText(_translate("Dialog", "OJT"))
        self.radioYes.setText(_translate("Dialog", "بله"))
        self.radioNo.setText(_translate("Dialog", "خیر"))
        self.btnFinish.setText(_translate("Dialog", "پایان"))
