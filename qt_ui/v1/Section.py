...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        Dialog.resize(900, 553)
        Dialog.setMinimumSize(QtCore.QSize(900, 553)) #553
    ...
    def retranslateUi(self, Dialog):
        ...
        Dialog.setWindowTitle(_translate("Dialog", "گروه"))
        self.lblName.setText(_translate("Dialog", "نام"))
        self.checkStay.setText(_translate("Dialog", "برگزاری در کلاس خاص"))
        self.btnFinish.setText(_translate("Dialog", "تایید"))
        self.btnCancel.setText(_translate("Dialog", "لغو"))
