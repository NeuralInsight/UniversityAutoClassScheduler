...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "برنامه ریزی خودکار"))
        self.tabInstructors.setWhatsThis(_translate("MainWindow", "<html><head/><body><p><br/></p></body></html>"))
        self.btnInstrAdd.setText(_translate("MainWindow", "اضافه کردن استاد"))
        self.btnInstrImport.setText(_translate("MainWindow", "اضافه کردن از فایل csv"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tabInstructors), _translate("MainWindow", "اساتید"))
        self.btnRoomAdd.setText(_translate("MainWindow", "اضافه کردن اتاق"))
        self.btnRoomImport.setText(_translate("MainWindow", "اضافه کردن از فایل csv"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tabRooms), _translate("MainWindow", "کلاس ها"))
        self.btnSubjAdd.setText(_translate("MainWindow", "اضافه کردن درس"))
        self.btnSubjImport.setText(_translate("MainWindow", "اضافه کردن از فایل csv"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tabSubjects), _translate("MainWindow", "درس ها"))
        self.btnSecAdd.setText(_translate("MainWindow", "اضافه کردن رشته-گروه"))
        self.btnSecImport.setText(_translate("MainWindow", "اضافه کردن از فایل csv"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tabSections), _translate("MainWindow", "رشته-گروه"))
        self.btnScenImport.setText(_translate("MainWindow", "ورودی"))
        self.btnScnExport.setText(_translate("MainWindow", "خروجی"))
        ...
        self.menuHelp.setTitle(_translate("MainWindow", "راهنما"))
        self.actionNew.setText(_translate("MainWindow", "جدید"))
        self.actionOpen.setText(_translate("MainWindow", "باز کردن"))
        self.actionSave.setText(_translate("MainWindow", "ذخیره"))
        self.actionSave_As.setText(_translate("MainWindow", " ذخیره به عنوان"))
        self.actionSettings.setText(_translate("MainWindow", "تنظیمات"))
        self.actionExit.setText(_translate("MainWindow", "خروج"))
        self.actionAdd_Instructor.setText(_translate("MainWindow", "اضافه کردن استاد"))
        self.actionView_Instructors.setText(_translate("MainWindow", "نمایش اساتید"))
        self.actionAdd_Room.setText(_translate("MainWindow", "اضافه کردن کلاس"))
        self.actionView_Rooms.setText(_translate("MainWindow", "نمایش کلاس ها"))
        self.actionAdd_Subject.setText(_translate("MainWindow", "اضافه کردن موضوع"))
        self.actionView_Subjects.setText(_translate("MainWindow", "نمایش موضوع ها"))
        ...
        self.actionImport.setText(_translate("MainWindow", "ورودی"))
        self.actionExport.setText(_translate("MainWindow", "خروجی"))
        self.actionView_Results.setText(_translate("MainWindow", "نمایش نتایج"))
        self.actionGenerate.setText(_translate("MainWindow", "Generate"))
        self.actionImport_2.setText(_translate("MainWindow", "ورودی"))
        self.actionExport_2.setText(_translate("MainWindow", "خروجی"))
        self.actionScenario_Summary.setText(_translate("MainWindow", "خلاصه سناریو"))
        self.actionGenerate_2.setText(_translate("MainWindow", "Generate"))
        self.actionView_Results_2.setText(_translate("MainWindow", "نمایش نتایج"))
        self.actionInstructions.setText(_translate("MainWindow", "Instructions"))
        self.actionAbout.setText(_translate("MainWindow", "درباره"))