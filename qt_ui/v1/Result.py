...
class Ui_Dialog(object):
    ...
    def retranslateUi(self, Dialog):
        ...
        Dialog.setWindowTitle(_translate("Dialog", "مشاهده نتیجه"))
        self.comboBox.setItemText(0, _translate("Dialog", "بخش ها"))
        self.comboBox.setItemText(1, _translate("Dialog", "اساتید"))
        self.comboBox.setItemText(2, _translate("Dialog", "کلاس ها"))
        self.comboBox_2.setItemText(0, _translate("Dialog", "نمونه سناریو 1"))
